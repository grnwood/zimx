...
def test_search_pages_hides_bare_journal_days_without_subpages(test_db):
    ...
    day_no_subpages = "/Journal/2026/01/14/14.txt"
    ...
    day_with_subpages = "/Journal/2026/01/15/15.txt"
    day_subpage = "/Journal/2026/01/15/SubPage/SubPage.txt"
    ...
    normal_page = "/Projects/Alpha/Alpha.txt"
